 ...
 * @return uint16_t
 */
uint16_t crc::modbus_crc_cal(uint16_t Data ,uint16_t GenPoly, uint16_t CrcData)
{
    uint16_t TmpI;
    Data *= 2;
...
*/
  ...
  * @return uint16_t
  */
uint16_t crc::get_crc(uint8_t *puchMsg, uint16_t usDataLen)
{
 ...
 * @return false
 */
bool crc::get_crc_result(uint8_t *puchMsg, uint16_t usDataLen)
{
    if(puchMsg == nullptr)
    {
        return false;
    ...
    uint8_t CRC_value_L = static_cast<uint8_t>(crc_ret &0x00FF);
    uint8_t CRC_value_H = static_cast<uint8_t>((crc_ret>>8)&0x00FF);
 ...
 * @return uint16_t
 */
uint16_t crc::modbus_crc_return(uint8_t *data, uint16_t data_len)
{
    uint16_t temp;
 ...
 * @return uint16_t
 */
uint16_t crc::modbus_crc_return_with_table(uint8_t *data, uint16_t data_len)
{
 ...
 */
bool crc::modbus_get_crc_result(uint8_t *msg ,uint16_t len)
{
